...
const GrantsPartial = ({
    ...
    handleDeleteGrant,
    handleAddGrant,
    grantForwardOrBackward 
}) => {

    return (
        <div>
            {/* Grant DETAILS */}
            <div id="grant-deets" className={`Segment ${grantFaded ? "Faded" : "Faded-in"}`}>
                <h4>Grant Details</h4>
                            ...
                            return (
                                ...
                                >
                                    <AuthInput
                                        ...
                                        mb={2}
                                        required={true}
                                        onChange={(event) => handleGrantChange(event, index)}
                                    />
                                    <AuthInput
                                        name="price"
                                        id={item?.price}
                ...
                >
                    <div className='prev-page' onClick={() => {grantForwardOrBackward('backward')}}>
                        <FaLongArrowAltLeft />
                    </div>
                    <div style={{ width: "200px"}}>
                        <ButtonSubmitGreen type="button" onClick={() => {
                            grantForwardOrBackward('forward')
                        }}>
            ...
            <div id="obj" className={`Segment ${objFaded ? "Faded" : "Faded-in"}`}>
                ...
                <Alert 
                    ...
                    severity="info"
                >
                    What need does your grant solve?
                </Alert>
            ...
            <div id="obj" className={`Segment ${customersFaded ? "Faded" : "Faded-in"}`}>
                ...
                <h4>Customers/Grants</h4>
                <Alert 
                    sx={{padding: '0 5px', display: 'flex', justifyContent: "center", fontSize: '.8rem', width: '300px', margin: "5px auto"}} 
                    severity="info"
                >
                    Enter previous or current <strong>customers/Grants</strong> who your have worked with/for. This will strengthen your conversion by 40%
                </Alert>
